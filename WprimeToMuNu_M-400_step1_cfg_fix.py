...
process.source = cms.Source("EmptySource", 
		...
		firstEvent=cms.untracked.uint32(2001),
...
###process.source = cms.Source("EmptySource", firstLuminosityBlock=cms.untracked.uint32(1), numberEventsInLuminosityBlock = cms.untracked.uint32(100 )  
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/WprimeToENu_M-400_NNPDF31nnlo_TuneCP5_13TeV_madgraph_cff.py nevts:50'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step1_WprimeToENu_M-400_1_2001_12345_20.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step1_WprimeToENu_M-400_1_2001_12345_20_inLHE.root'),
    dataset = cms.untracked.PSet(
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/x3/cms/jelee/MCProd/mg26X/genproductions/bin/MadGraph5_aMCatNLO/WprimeToENu_M-400_NLO_NNPDF31nnlo_slc6_amd64_gcc630_CMSSW_9_3_8_tarball.tar.xz'),
